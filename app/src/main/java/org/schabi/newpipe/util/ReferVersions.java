...
//                FacebookReport.logSentFBRegionOpen("my");
                return true;
            }
...
//                FacebookReport.logSentFBRegionOpen("pe");
            ...
            if ("hn".equals(country.toLowerCase())) {
//                FacebookReport.logSentFBRegionOpen("hn");
                return true;
            }

            if ("dz".equals(country.toLowerCase())) {
//                FacebookReport.logSentFBRegionOpen("dz");
                return true;
            }

            if ("il".equals(country.toLowerCase())) {
//                FacebookReport.logSentFBRegionOpen("il");
                return true;
            }
